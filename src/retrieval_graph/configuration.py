...
class AgentConfiguration(BaseConfiguration):
    ...
    document_eval_system_prompt: str = field(
        default=prompts.EVALUATE_DOCUMENTS_SYSTEM_PROMPT,
        metadata={
            "description": "The system prompt used for evaluating documents based on a query."
        },
    )
